...
class OptparseGutenberg
  ...
  def self.parse(args)
    ...
    opts = OptionParser.new do |opts|
      ...
      opts.separator ""
      opts.separator "    gutenberg-couchdb.rb --recreate -p 4000 the-sign-of-the-four.txt \"The sign of the four\""
      opts.separator ""
...
database = "http://sigma.inf.ug.edu.pl:#{options.port}/#{options.database}"
